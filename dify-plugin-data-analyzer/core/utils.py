...
def build_file_path(thread_id: str, rel_path: str) -> str:
    """Build file path relative to workspace base directory"""
    return os.path.join(WORKSPACE_BASE_DIR, thread_id, rel_path)
...
def generate_report_from_messages(
    ...
    try:
        ...
        url = build_file_path(thread_id, rel_path)
